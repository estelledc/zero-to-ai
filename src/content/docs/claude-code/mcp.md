...
- 你已经用 Claude Code 完成过日常工作（参考[快速上手](/zero-to-ai/claude-code/quickstart/)）
- 你理解 CLAUDE.md、Skill、Hook 的基本概念（参考[核心配置](/zero-to-ai/claude-code/config/)、[Skill 体系](/zero-to-ai/claude-code/skills/)）
...
- 回到[日常节奏](/zero-to-ai/claude-code/daily-rhythm/)巩固基础工作流——这才是每天都会用的东西
- 看看[上下文管理](/zero-to-ai/claude-code/context/)了解如何更有效地利用上下文空间
