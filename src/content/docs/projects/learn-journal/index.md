...
如果你不满足上面任何一条，这套东西目前不适合你。天花板：理论上限数万人（截至 2025 年估算），实际可触达 < 1000 人。这不是问题——验证假设不需要大用户量。

## 它从哪来

从数月持续实践中提炼（其中密集验证约 50 天）。184 篇笔记、27 个问题记录、14 个 AI skill 的实战验证。
...
- [它是怎么工作的](/projects/learn-journal/how-it-works/)——核心循环、六步讲解、自然复用的详细解释
