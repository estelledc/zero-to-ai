...
Memory 解决"新会话 Claude 失忆"的问题。它的设计原则和三层稀疏结构详见 [记忆系统设计原则](/zero-to-ai/methodology/memory-system-design/)，这里不重复。从工作流角度看，Memory 的角色是：**让错误只需要犯一次**。
...
这是 CLAUDE.md 编写哲学的核心：每犯一次错，加一条规则。具体方法见 [CLAUDE.md 编写哲学](/zero-to-ai/methodology/claude-md-philosophy/)。
...
- [记忆系统设计原则](/zero-to-ai/methodology/memory-system-design/) -- 工作流里的 Memory 怎么设计三层稀疏结构
- [CLAUDE.md 编写哲学](/zero-to-ai/methodology/claude-md-philosophy/) -- 错误恢复循环的第一步（加规则）的具体方法
- [Claude Code Skill 系统](/zero-to-ai/claude-code/skills/) -- 怎么写一个可复用的 Skill
- [学习方法论总览](/zero-to-ai/methodology/) -- 回到方法论索引
